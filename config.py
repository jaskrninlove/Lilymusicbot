...
class Config:
    ...
    def __init__(self):
        ...
        self.SUPPORT_CHANNEL: str = getenv(
            "SUPPORT_CHANNEL", "https://t.me/elysiiannetwork")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "https://t.me/+BQU925hNgmJjNWNl")
        ...
        self.YOUTUBE_API_URL: str = getenv("YOUTUBE_API_URL", "shrutibots.site")

        # ============ IMAGE URLS ============
        # URLs for various bot images
        self.DEFAULT_THUMB: str = getenv(
            "DEFAULT_THUMB",
            "https://i.pinimg.com/736x/b4/80/76/b480762f8109d74561a9da817c1e3ed4.jpg"  # Default thumbnail
        )
